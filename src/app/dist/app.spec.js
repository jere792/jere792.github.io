...
describe('App', function () {
    ...
    it('should render title', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    fixture = testing_1.TestBed.createComponent(app_1.App);
                    return [4 /*yield*/, fixture.whenStable()];
                case 1:
                    _b.sent();
                    compiled = fixture.nativeElement;
                    expect((_a = compiled.querySelector('h1')) === null || _a === void 0 ? void 0 : _a.textContent).toContain('Hello, jere792.github.io');
                    return [2 /*return*/];
            }
        });
    }); });
